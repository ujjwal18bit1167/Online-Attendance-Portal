                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="card card-body  ">
                                    <div class="card-body  " style='background-color:#ffdead !important'>
                                        ...
                                        <form action="removestudentsave.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Enter admission no."
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-danger btn-block" name="s"> Remove student
                                                    </button>
                                        ...
                                        <p style="color:green;">  
                                            <?php
                                               if(isset($_SESSION['removestudentsession'])
                                               )
                                              {
                                                   echo "Student removed successfully ";
                                                   unset($_SESSION['removestudentsession']);
                                              }
                                               else if(isset($_SESSION['studentcouldnotberemoved']))
                                               {
                                                 echo "Student could not be removed";
                                                 unset($_SESSION['studentcouldnotberemoved']);
                                               }
                                            ?>
