                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="card card-body  ">
                                    <div class="card-body  " style='background-color:#ffdead !important'>
                                        <h3 style=" text-align: center; color:brown;">Edit Profile</h3>
                                        <form action="editprofilesave.php" method="post">
                                           ...
                                           <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Enter new mobile no."
                                                    type="text" name="mob">
                                            </div> <!-- form-group// -->
                                   ...
                                   <p style="color:green;">
                                     <?php
                                        if(isset($_SESSION['editprofilesession']))
                                           {
                                                 echo "Your profile has been updated successfully";
                                               unset($_SESSION['editprofilesession']);
                                           } 
                                           else if(isset($_SESSION['incorrectemailsession']))
                                           {
                                               echo "Please enter your correct email";
                                               unset($_SESSION['incorrectemailsession']);
                                           }    
                                     ?>
                                   </p>
