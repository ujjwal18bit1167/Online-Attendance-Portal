...
// if(!isset($_GET['removefacultysession'])|| )
//      header("location:home.php");

//unset($_GET['removefacultysession']);
$email=$_SESSION['e'];
?>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="card card-body  ">
                                    <div class="card-body  " style='background-color:#ffdead !important'>
                                        ...
                                        <form action="removefacultysave.php" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" placeholder="Enter faculty id"
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-danger btn-block"  name='s'> Remove
                                                        faculty
                                                    </button>
                                              ...
                                              <p style="color:green;">
                               <?php
                                  if(isset($_SESSION['facultyremoved']))
                                    {

                                     echo "Faculty removed successfully";
                                     unset($_SESSION['facultyremoved']);
                                    }
                                ?>
                             </p>
